    ...
    <LayoutGroup id={slug?.join("/")}>
      ...
      >
        ...
        <motion.div
          ...
          className="z-10 col-start-1 row-start-1 hidden self-stretch justify-self-stretch bg-gradient-to-b from-transparent from-70% to-black to-95% dark:to-slate-800 sm:block"
        />
        <Link
          to={slug?.join("/") ?? "/"}
        ...
        >
          ...
          <motion.h1
            className="col-start-1 row-start-1 text-white drop-shadow-md px-4"
            layoutId="title"
            layout="position"
          >
            {title}
